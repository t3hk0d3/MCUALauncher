...
public class OptionsDialog extends javax.swing.JDialog {
    ...
    public OptionsDialog(java.awt.Frame parent, LauncherOptions options) {
        ...
        this.autoconnectCheckbox.setSelected(options.isAutoConnect());
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText(string("autoconnect_label"));

        autoconnectCheckbox.setText(string("autoconnect_checkbox"));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(autoconnectCheckbox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(20, 20, 20)
    ...
    private void doneButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneButtonActionPerformed
        ...
        this.options.setAutoConnect(this.autoconnectCheckbox.isSelected());
